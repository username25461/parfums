...
!(function (t, e) {
    ...
    function y(t, e, n) {
        ...
        if (((s.text = t), e)) for (i in m) (o = e[i] || (e.getAttribute && e.getAttribute(i))) && s.setAttribute(i, o);
    ...
    (x.fn = x.prototype = {
        ...
        (x.extend = x.fn.extend = function () {
            var t,
                ...
                l = arguments.length,
                c = !1;
            for ("boolean" == typeof r && ((c = r), (r = arguments[a] || {}), a++), "object" == _typeof(r) || h(r) || (r = {}), a === l && ((r = this), a--); a < l; a++)
                        ...
                        (i = t[e]),
                            "__proto__" !== e &&
                                ...
                                (c && i && (x.isPlainObject(i) || (o = Array.isArray(i)))
                                    ? ((n = r[e]), (s = o && !Array.isArray(n) ? [] : o || x.isPlainObject(n) ? n : {}), (o = !1), (r[e] = x.extend(c, s, i)))
                                    : void 0 !== i && (r[e] = i));
            return r;
        }),
        x.extend({
            ...
            isPlainObject: function t(e) {
                var n, o;
                return !(!e || "[object Object]" !== c.call(e)) && (!(n = i(e)) || ("function" == typeof (o = d.call(n, "constructor") && n.constructor) && u.call(o) === p));
            },
            ...
            each: function t(e, n) {
                var i,
                    o = 0;
                if (_(e)) for (i = e.length; o < i && !1 !== n.call(e[o], o, e[o]); o++);
                else for (o in e) if (!1 === n.call(e[o], o, e[o])) break;
                return e;
            },
            makeArray: function t(e, n) {
                var i = n || [];
                return null != e && (_(Object(e)) ? x.merge(i, "string" == typeof e ? [e] : e) : r.call(i, e)), i;
            },
            ...
            grep: function t(e, n, i) {
                for (var o = [], s = 0, r = e.length, a = !i; s < r; s++) !n(e[s], s) !== a && o.push(e[s]);
                return o;
            },
            map: function t(e, n, i) {
                var o,
                    ...
                    a = 0,
                    l = [];
                if (_(e)) for (o = e.length; a < o; a++) null != (r = n(e[a], a, i)) && l.push(r);
    ...
    var w = (function (t) {
        ...
        try {
            H.apply((L = q.call(_.childNodes)), _.childNodes), L[_.childNodes.length].nodeType;
        } catch (tl) {
            H = {
                apply: L.length
                    ? function (t, e) {
            ...
            if (!o && (p(e), (e = e || f), g)) {
                if (11 !== _ && (u = tt.exec(t))) {
                    if ((s = u[1])) {
                        ...
                        if ((s = u[3]) && n.getElementsByClassName && e.getElementsByClassName) return H.apply(i, e.getElementsByClassName(s)), i;
                    }
                }
                if (n.qsa && !A[t + " "] && (!v || !v.test(t)) && (1 !== _ || "object" !== e.nodeName.toLowerCase())) {
                    if (((m = t), (y = e), 1 === _ && (Y.test(t) || X.test(t)))) {
                        for (((y = (te.test(t) && t$(e.parentNode)) || e) === e && n.scope) || ((d = e.getAttribute("id")) ? (d = d.replace(to, ts)) : e.setAttribute("id", (d = x))), a = (h = r(t)).length; a--; )
        ...
        (p = tc.setDocument = function (t) {
            ...
            return (
                r != f &&
                    ...
                    (g = !s(f)),
                    _ != f && (o = f.defaultView) && o.top !== o && (o.addEventListener ? o.addEventListener("unload", tr, !1) : o.attachEvent && o.attachEvent("onunload", tr)),
                    ...
                    (n.qsa = Q.test(f.querySelectorAll)) &&
                        (tp(function (t) {
                            ...
                            (h.appendChild(t).innerHTML = "<a id='" + x + "'></a><select id='" + x + "-\r\\' msallowcapture=''><option selected=''></option></select>"),
                                ...
                                t.querySelectorAll("[selected]").length || v.push("\\[" + z + "*(?:value|" + N + ")"),
                    ...
                    (P = e
                        ...
                        : function (t, e) {
                              ...
                              var n,
                                  ...
                                  r = [t],
                                  a = [e];
                              if (!o || !s) return t == f ? -1 : e == f ? 1 : o ? -1 : s ? 1 : d ? O(d, t) - O(d, e) : 0;
                              if (o === s) return th(t, e);
                              for (n = t; (n = n.parentNode); ) r.unshift(n);
                              for (n = e; (n = n.parentNode); ) a.unshift(n);
                              for (; r[i] === a[i]; ) i++;
                              return i ? th(r[i], a[i]) : r[i] == _ ? -1 : a[i] == _ ? 1 : 0;
                          })),
                f
            );
        }),
        ...
        (tc.uniqueSort = function (t) {
            var e,
                ...
                o = 0,
                s = 0;
            if (((u = !n.detectDuplicates), (d = !n.sortStable && t.slice(0)), t.sort(P), u)) {
                for (; (e = t[s++]); ) e === t[s] && (o = i.push(s));
                for (; o--; ) t.splice(i[o], 1);
            }
            return (d = null), t;
        }),
        (o = tc.getText = function (t) {
            var e,
                n = "",
                i = 0,
                s = t.nodeType;
        ...
        ((i = tc.selectors = {
            ...
            preFilter: {
                ATTR: function t(e) {
                    return (e[1] = e[1].replace(tn, ti)), (e[3] = (e[3] || e[4] || e[5] || "").replace(tn, ti)), "~=" === e[2] && (e[3] = " " + e[3] + " "), e.slice(0, 4);
                },
                CHILD: function t(e) {
                    return (
                        (e[1] = e[1].toLowerCase()),
                        "nth" === e[1].slice(0, 3) ? (e[3] || tc.error(e[0]), (e[4] = +(e[4] ? e[5] + (e[6] || 1) : 2 * ("even" === e[3] || "odd" === e[3]))), (e[5] = +(e[7] + e[8] || "odd" === e[3]))) : e[3] && tc.error(e[0]),
                        e
                    );
                },
                PSEUDO: function t(e) {
                    ...
                    return G.CHILD.test(e[0])
                        ? null
                        : (e[3] ? (e[2] = e[4] || e[5] || "") : i && U.test(i) && (n = r(i, !0)) && (n = i.indexOf(")", i.length - n) - i.length) && ((e[0] = e[0].slice(0, n)), (e[2] = i.slice(0, n))), e.slice(0, 3));
                },
            },
            filter: {
                TAG: function t(e) {
                    ...
                    return 1 === o && 0 === s
                        ...
                        : function (t, n, i) {
                              ...
                              if (v) {
                                  if (r) {
                                      for (; g; ) {
                                          for (p = t; (p = p[g]); ) if (l ? p.nodeName.toLowerCase() === m : 1 === p.nodeType) return !1;
                                  ...
                                  if (((h = [a ? v.firstChild : v.lastChild]), a && y)) {
                                      for (
                                          b = (f = (c = (d = (u = (p = v)[x] || (p[x] = {}))[p.uniqueID] || (u[p.uniqueID] = {}))[e] || [])[0] === w && c[1]) && c[2], p = f && v.childNodes[f];
                                  ...
                                  } else if ((y && (b = f = (c = (d = (u = (p = t)[x] || (p[x] = {}))[p.uniqueID] || (u[p.uniqueID] = {}))[e] || [])[0] === w && c[1]), !1 === b))
                                      for (
                                          ;
                                          (p = (++f && p && p[g]) || (b = f = 0) || h.pop()) &&
                                          ((l ? p.nodeName.toLowerCase() !== m : 1 !== p.nodeType) || !++b || (y && ((d = (u = p[x] || (p[x] = {}))[p.uniqueID] || (u[p.uniqueID] = {}))[e] = [w, b]), p !== t));
                ...
                PSEUDO: function t(e, n) {
                    var o,
                        s = i.pseudos[e] || i.setFilters[e.toLowerCase()] || tc.error("unsupported pseudo: " + e);
                    return s[x]
                        ? s(n)
                        : s.length > 1
                        ? ((o = [e, e, "", n]),
                          i.setFilters.hasOwnProperty(e.toLowerCase())
                              ? tu(function (t, e) {
                                    for (var i, o = s(t, n), r = o.length; r--; ) t[(i = O(t, o[r]))] = !(e[i] = o[r]);
                                })
                              : function (t) {
                                    return s(t, 0, o);
                                })
            ...
            return e.first
                ...
                : function (e, n, l) {
                      ...
                      if (l) {
                          ...
                          for (; (e = e[i]); )
                              if (1 === e.nodeType || r) {
                                  if (((d = (u = e[x] || (e[x] = {}))[e.uniqueID] || (u[e.uniqueID] = {})), o && o === e.nodeName.toLowerCase())) e = e[i] || e;
                                  else {
            ...
            return (
                ...
                tu(function (s, r, a, l) {
                    var c,
                        ...
                        m = n ? (o || (s ? t : h || i) ? [] : r) : v;
                    if ((n && n(v, m, a, l), i)) for (c = tT(m, f), i(c, [], a, l), d = c.length; d--; ) (u = c[d]) && (m[f[d]] = !(v[f[d]] = u));
                    if (s) {
                        if (o || t) {
                            if (o) {
            ...
            for (
                ...
                if ((n = i.relative[t[l].type])) p = [t_(tw(p), n)];
                    ...
                    if ((n = i.filter[t[l].type].apply(null, t[l].matches))[x]) {
                        ...
                        return tS(l > 1 && tw(p), l > 1 && tx(t.slice(0, l - 1).concat({ value: " " === t[l - 2].type ? "*" : "" })).replace(B, "$1"), n, l < o && tC(t.slice(l, o)), o < s && tC((t = t.slice(o))), o < s && tx(t));
                    }
                    p.push(n);
                }
            return tw(p);
        ...
        return (
            ...
            (r = tc.tokenize = function (t, e) {
                ...
                for (a = t, l = [], c = i.preFilter; a; ) {
                    ...
                    (n = !1),
                    (o = X.exec(a)) && ((n = o.shift()), s.push({ value: n, type: o[0].replace(B, " ") }), (a = a.slice(n.length))),
                    i.filter))
            ...
            (a = tc.compile = function (t, e) {
                var n,
                    ...
                    v = k[t + " "];
                if (!v) {
                    for (e || (e = r(t)), d = e.length; d--; ) (v = tC(e[d]))[x] ? u.push(v) : h.push(v);
                    (v = k(
                        t,
                        ((n = h),
                        (s = (o = u).length > 0),
                        ...
                        (l = function t(e, r, l, d, u) {
                            var h,
                                ...
                                k = S.length;
                            for (u && (c = r == f || r || u); b !== k && null != (h = S[b]); b++) {
                                if (a && h) {
                                    for (v = 0, r || h.ownerDocument == f || (p(h), (l = !g)); (m = n[v++]); )
                                        if (m(h, r || f, l)) {
                                            d.push(h);
                                            break;
                                        }
                            ...
                            if (((y += b), s && b !== y)) {
                                ...
                                H.apply(d, _), u && !e && _.length > 0 && y + o.length > 1 && tc.uniqueSort(d);
                            }
                            return u && ((w = C), (c = T)), x;
                        }),
                        s ? tu(l) : l)
            ...
            (l = tc.select = function (t, e, n, o) {
                ...
                if (((n = n || []), 1 === f.length)) {
                    if ((l = f[0] = f[0].slice(0)).length > 2 && "ID" === (c = l[0]).type && 9 === e.nodeType && g && i.relative[l[1].type]) {
                        if (!(e = (i.find.ID(c.matches[0].replace(tn, ti), e) || [])[0])) return n;
                        p && (e = e.parentNode), (t = t.slice(l.shift().value.length));
                    }
                    for (s = G.needsContext.test(t) ? 0 : l.length; s-- && ((c = l[s]), !i.relative[(d = c.type)]); )
                        if ((u = i.find[d]) && (o = u(c.matches[0].replace(tn, ti), (te.test(l[0].type) && t$(e.parentNode)) || e))) {
                            if ((l.splice(s, 1), !(t = o.length && tx(l)))) return H.apply(n, o), n;
                            break;
                        }
                }
                return (p || a(t, f))(o, e, !g, n, !e || (te.test(t) && t$(e.parentNode)) || e), n;
            }),
    ...
    (x.filter = function (t, e, n) {
        ...
        x.fn.extend({
            ...
            is: function t(e) {
                return !!P(this, "string" == typeof e && C.test(e) ? x(e) : e || [], !1).length;
            },
        });
    var E,
        L = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
    ((x.fn.init = function (t, e, n) {
        ...
        if (((n = n || E), "string" == typeof t)) {
            ...
            if (i[1]) {
                if (((e = e instanceof x ? e[0] : e), x.merge(this, x.parseHTML(i[1], e && e.nodeType ? e.ownerDocument || e : v, !0)), A.test(i[1]) && x.isPlainObject(e))) for (i in e) h(this[i]) ? this[i](e[i]) : this.attr(i, e[i]);
                return this;
            }
        ...
        x.each(
            ...
            function (t, e) {
                x.fn[t] = function (n, i) {
                    ...
                    return "Until" !== t.slice(-5) && (i = n), i && "string" == typeof i && (o = x.filter(i, o)), this.length > 1 && (j[t] || x.uniqueSort(o), D.test(t) && o.reverse()), this.pushStack(o);
                };
            }
        );
    var q = /[^\x20\t\r\n\f]+/g;
        ...
        var e,
            ...
            u = {
                        ...
                        a &&
                            ...
                            (function e(n) {
                                x.each(n, function (n, i) {
                                    h(i) ? (t.unique && u.has(i)) || a.push(i) : i && i.length && "string" !== b(i) && e(i);
                                });
                            })(arguments),
                            o && !i && d()),
                        this
                ...
                remove: function t() {
                    return (
                        x.each(arguments, function (t, e) {
                            for (var n; (n = x.inArray(e, a, n)) > -1; ) a.splice(n, 1), n <= c && c--;
                        }),
                        this
                    );
                },
                ...
                fireWith: function t(e, n) {
                    return r || ((n = [e, (n = n || []).slice ? n.slice() : n]), l.push(n), i || d()), this;
                },
                fire: function t() {
        ...
        x.extend({
                ...
                var i = [
                    ...
                    s = {
                        ...
                        then: function e(n, o, s) {
                                ...
                                return function () {
                                    var s = this,
                                        ...
                                        c = function t() {
                                            var c, t;
                                            if (!(e < r)) {
                                                if ((c = i.apply(s, l)) === n.promise()) throw TypeError("Thenable self-resolution");
                                                (t = c && ("object" == _typeof(c) || "function" == typeof c) && c.then),
                                                    h(t)
                                                        ? o
                                                            ? t.call(c, a(r, n, O, o), a(r, n, N, o))
                                                            : (r++, t.call(c, a(r, n, O, o), a(r, n, N, o), a(r, n, O, n.notifyWith)))
                                                        : (i !== O && ((s = void 0), (l = [c])), (o || n.resolveWith)(s, l));
                                            }
                                        },
                                        d = o
                                            ? c
                                            : function () {
                                                  try {
                                                      ...
                                                      x.Deferred.exceptionHook && x.Deferred.exceptionHook(t, d.stackTrace), e + 1 >= r && (i !== N && ((s = void 0), (l = [t])), n.rejectWith(s, l));
                                                  }
                                              };
                            ...
                            return x
                                .Deferred(function (t) {
                                    i[0][3].add(a(0, t, h(s) ? s : O, t.notifyWith)), i[1][3].add(a(0, t, h(n) ? n : O)), i[2][3].add(a(0, t, h(o) ? o : N));
                                })
                                .promise();
                        },
            ...
            when: function t(e) {
                var n = arguments.length,
                    ...
                    l = function t(e) {
                        return function (t) {
                            (s[e] = this), (r[e] = arguments.length > 1 ? o.call(arguments) : t), --n || a.resolveWith(s, r);
                        };
                    };
                if (n <= 1 && (z(e, a.done(l(i)).resolve, a.reject, !n), "pending" === a.state() || h(r[i] && r[i].then))) return a.then();
    ...
    var F = x.Deferred();
    function M() {
        v.removeEventListener("DOMContentLoaded", M), t.removeEventListener("load", M), x.ready();
    }
    (x.fn.ready = function (t) {
        ...
        x.extend({
            ...
            readyWait: 1,
            ready: function t(e) {
                (!0 === e ? --x.readyWait : x.isReady) || ((x.isReady = !0), (!0 !== e && --x.readyWait > 0) || F.resolveWith(v, [x]));
            },
        }),
        (x.ready.then = F.then),
        "complete" !== v.readyState && ("loading" === v.readyState || v.documentElement.doScroll) ? (v.addEventListener("DOMContentLoaded", M), t.addEventListener("load", M)) : t.setTimeout(x.ready);
    var R = function t(e, n, i, o, s, r, a) {
            var l = 0,
                c = e.length,
                d = null == i;
            if ("object" === b(i)) for (l in ((s = !0), i)) t(e, n, l, i[l], !0, r, a);
            else if (
                void 0 !== o &&
                ((s = !0),
                h(o) || (a = !0),
    ...
    (V.uid = 1),
        (V.prototype = {
            cache: function t(e) {
                ...
                return n || ((n = {}), U(e) && (e.nodeType ? (e[this.expando] = n) : Object.defineProperty(e, this.expando, { value: n, configurable: !0 }))), n;
            },
            ...
            get: function t(e, n) {
                return void 0 === n ? this.cache(e) : e[this.expando] && e[this.expando][Y(n)];
            },
            ...
            remove: function t(e, n) {
                var i,
                    o = e[this.expando];
                if (void 0 !== o) {
                    if (void 0 !== n) for (i = (n = Array.isArray(n) ? n.map(Y) : ((n = Y(n)) in o) ? [n] : n.match(q) || []).length; i--; ) delete o[n[i]];
                    (void 0 === n || x.isEmptyObject(o)) && (e.nodeType ? (e[this.expando] = void 0) : delete e[this.expando]);
                }
            },
    ...
    function Q(t, e, n) {
        ...
        if (void 0 === n && 1 === t.nodeType) {
            if (((i = "data-" + e.replace(J, "-$&").toLowerCase()), "string" == typeof (n = t.getAttribute(i)))) {
                try {
                    n = ((o = n), "true" === o || ("false" !== o && ("null" === o ? null : o === +o + "" ? +o : Z.test(o) ? JSON.parse(o) : o)));
                } catch (s) {}
                K.set(t, e, n);
            } else n = void 0;
        }
    ...
    x.extend({
            ...
            data: function t(e, n) {
                ...
                if (void 0 === e) {
                    if (this.length && ((s = K.get(r)), 1 === r.nodeType && !G.get(r, "hasDataAttrs"))) {
                        for (i = a.length; i--; ) a[i] && 0 === (o = a[i].name).indexOf("data-") && Q(r, (o = Y(o.slice(5))), s[o]);
                ...
                return "object" == _typeof(e)
                    ...
                    : R(
                          ...
                          function (t) {
                              var n;
                              if (r && void 0 === t) return void 0 !== (n = K.get(r, e)) ? n : void 0 !== (n = Q(r, e)) ? n : void 0;
                              this.each(function () {
                                  K.set(this, e, t);
                              });
                          },
        ...
        x.extend({
            queue: function t(e, n, i) {
                var o;
                if (e) return (n = (n || "fx") + "queue"), (o = G.get(e, n)), i && (!o || Array.isArray(i) ? (o = G.access(e, n, x.makeArray(i))) : o.push(i)), o || [];
            },
        ...
        x.fn.extend({
            ...
            promise: function t(e, n) {
                ...
                for ("string" != typeof e && ((n = e), (e = void 0)), e = e || "fx"; a--; ) (i = G.get(r[a], e + "queueHooks")) && i.empty && (o++, i.empty.add(l));
    ...
    ti.getRootNode &&
        (to = function t(e) {
            return x.contains(e.ownerDocument, e) || e.getRootNode(ts) === e.ownerDocument;
        });
    var tr = function t(e, n) {
        return "none" === (e = n || e).style.display || ("" === e.style.display && to(e) && "none" === x.css(e, "display"));
    };
    function ta(t, e, n, i) {
        var o,
            s,
            ...
            d = t.nodeType && (x.cssNumber[e] || ("px" !== c && +l)) && te.exec(x.css(t, e));
        if (d && d[3] !== c) {
            for (l /= 2, c = c || d[3], d = +l || 1; r--; ) x.style(t, e, d + c), (1 - s) * (1 - (s = a() / l || 0.5)) <= 0 && (r = 0), (d /= s);
    ...
    function tc(t) {
        var e,
            ...
            i = t.nodeName,
            o = tl[i];
        return o || ((e = n.body.appendChild(n.createElement(i))), (o = x.css(e, "display")), e.parentNode.removeChild(e), "none" === o && (o = "block"), (tl[i] = o), o);
    }
    function td(t, e) {
        for (var n, i, o = [], s = 0, r = t.length; s < r; s++)
            (i = t[s]).style &&
                ((n = i.style.display),
                e ? ("none" === n && ((o[s] = G.get(i, "display") || null), o[s] || (i.style.display = "")), "" === i.style.display && tr(i) && (o[s] = tc(i))) : "none" !== n && ((o[s] = "none"), G.set(i, "display", n)));
    ...
    var tv = { thead: [1, "<table>", "</table>"], col: [2, "<table><colgroup>", "</colgroup></table>"], tr: [2, "<table><tbody>", "</tbody></table>"], td: [3, "<table><tbody><tr>", "</tr></tbody></table>"], _default: [0, "", ""] };
    function tm(t, e) {
        var n;
    ...
    (tv.tbody = tv.tfoot = tv.colgroup = tv.caption = tv.thead), (tv.th = tv.td), f.option || (tv.optgroup = tv.option = [1, "<select multiple='multiple'>", "</select>"]);
    var t$ = /<|&#?\w+;/;
        ...
        for (var s, r, a, l, c, d, u = e.createDocumentFragment(), p = [], f = 0, h = t.length; f < h; f++)
            if ((s = t[f]) || 0 === s) {
                if ("object" === b(s)) x.merge(p, s.nodeType ? [s] : s);
                    ...
                    for (r = r || u.appendChild(e.createElement("div")), l = tv[(a = (th.exec(s) || ["", ""])[1].toLowerCase())] || tv._default, r.innerHTML = l[1] + x.htmlPrefilter(s) + l[2], d = l[0]; d--; ) r = r.lastChild;
                    x.merge(p, r.childNodes), ((r = u.firstChild).textContent = "");
                } else p.push(e.createTextNode(s));
            }
        for (u.textContent = "", f = 0; (s = p[f++]); )
            if (i && x.inArray(s, i) > -1) o && o.push(s);
            else if (((c = to(s)), (r = tm(u.appendChild(s), "script")), c && ty(r), n)) for (d = 0; (s = r[d++]); ) tg.test(s.type || "") && n.push(s);
        return u;
    }
    var tx = /^([^.]*)(?:\.(.+)|)/;
    function t_() {
    ...
    function tS(t, e, n, i, o, s) {
        var r, a;
        if ("object" == _typeof(e)) {
            for (a in ("string" != typeof n && ((i = i || n), (n = void 0)), e)) tS(t, a, n, i, e[a], s);
            return t;
        }
        if ((null == i && null == o ? ((o = n), (i = n = void 0)) : null == o && ("string" == typeof n ? ((o = i), (i = void 0)) : ((o = i), (i = n), (n = void 0))), !1 === o)) o = tw;
        else if (!o) return t;
        return (
            1 === s &&
                ((r = o),
              ...
              x.event.add(t, e, {
                  ...
                  handler: function t(i) {
                      ...
                      if (1 & i.isTrigger && this[e]) {
                          if (a.length) (x.event.special[e] || {}).delegateType && i.stopPropagation();
                          else if (((a = o.call(arguments)), G.set(this, e, a), (s = n(this, e)), this[e](), a !== (r = G.get(this, e)) || s ? G.set(this, e, !1) : (r = {}), a !== r))
                              return i.stopImmediatePropagation(), i.preventDefault(), r && r.value;
                      } else a.length && (G.set(this, e, { value: x.event.trigger(x.extend(a[0], x.Event.prototype), a.slice(1), this) }), i.stopImmediatePropagation());
                  },
              }))
    ...
    (x.event = {
                ...
                for (
                    ...
                    (h = v = (l = tx.exec(n[d]) || [])[1]),
                        ...
                        h &&
                            ...
                            (p = x.event.special[h] || {}),
                            (u = x.extend({ type: h, origType: v, data: o, handler: i, guid: i.guid, selector: s, needsContext: s && x.expr.match.needsContext.test(s), namespace: g.join(".") }, r)),
                            (f = c[h]) || (((f = c[h] = []).delegateCount = 0), (p.setup && !1 !== p.setup.call(e, o, g, a)) || (e.addEventListener && e.addEventListener(h, a))),
        ...
        remove: function t(e, n, i, o, s) {
            ...
            if (m && (c = m.events)) {
                for (d = (n = (n || "").match(q) || [""]).length; d--; )
                    if (((h = v = (l = tx.exec(n[d]) || [])[1]), (g = (l[2] || "").split(".").sort()), h)) {
                        for (p = x.event.special[h] || {}, f = c[(h = (o ? p.delegateType : p.bindType) || h)] || [], l = l[2] && RegExp("(^|\\.)" + g.join("\\.(?:.*\\.|)") + "(\\.|$)"), a = r = f.length; r--; )
                            (u = f[r]),
                                (!s && v !== u.origType) ||
                                    (i && i.guid !== u.guid) ||
                        ...
                        a && !f.length && ((p.teardown && !1 !== p.teardown.call(e, g, m.handle)) || x.removeEvent(e, h, m.handle), delete c[h]);
        ...
        dispatch: function t(e) {
            ...
            if (((c.delegateTarget = this), !u.preDispatch || !1 !== u.preDispatch.call(this, c))) {
                for (a = x.event.handlers.call(this, c, d), n = 0; (s = a[n++]) && !c.isPropagationStopped(); )
                    for (c.currentTarget = s.elem, i = 0; (r = s.handlers[i++]) && !c.isImmediatePropagationStopped(); )
                        (c.rnamespace && !1 !== r.namespace && !c.rnamespace.test(r.namespace)) ||
                            ((c.handleObj = r), (c.data = r.data), void 0 !== (o = ((x.event.special[r.origType] || {}).handle || r.handler).apply(s.elem, l)) && !1 === (c.result = o) && (c.preventDefault(), c.stopPropagation()));
            ...
            if (c && d.nodeType && !("click" === e.type && e.button >= 1)) {
                for (; d !== this; d = d.parentNode || this)
                    if (1 === d.nodeType && ("click" !== e.type || !0 !== d.disabled)) {
                        for (r = [], a = {}, i = 0; i < c; i++) void 0 === a[(s = (o = n[i]).selector + " ")] && (a[s] = o.needsContext ? x(s, this).index(d) > -1 : x.find(s, this, null, [d]).length), a[s] && r.push(o);
                        r.length && l.push({ elem: d, handlers: r });
                    }
            }
            return (d = this), c < n.length && l.push({ elem: d, handlers: n.slice(c) }), l;
        },
        ...
        special: {
            ...
            click: {
                setup: function t(e) {
                    var n = this || e;
                    return tf.test(n.type) && n.click && k(n, "input") && tC(n, "click", t_), !1;
                },
                trigger: function t(e) {
                    var n = this || e;
                    return tf.test(n.type) && n.click && k(n, "input") && tC(n, "click"), !0;
                },
                _default: function t(e) {
                    var n = e.target;
                    return (tf.test(n.type) && n.click && k(n, "input") && G.get(n, "click")) || k(n, "a");
                },
            },
            beforeunload: {
        ...
        (x.Event = function (t, e) {
            ...
            t && t.type
                ? ((this.originalEvent = t),
                  (this.type = t.type),
                  (this.isDefaultPrevented = t.defaultPrevented || (void 0 === t.defaultPrevented && !1 === t.returnValue) ? t_ : tw),
        ...
        (x.Event.prototype = {
            ...
            preventDefault: function t() {
                ...
                (this.isDefaultPrevented = t_), e && !this.isSimulated && e.preventDefault();
            },
            stopPropagation: function t() {
                var e = this.originalEvent;
                (this.isPropagationStopped = t_), e && !this.isSimulated && e.stopPropagation();
            },
            stopImmediatePropagation: function t() {
                var e = this.originalEvent;
                (this.isImmediatePropagationStopped = t_), e && !this.isSimulated && e.stopImmediatePropagation(), this.stopPropagation();
            },
        }),
        x.each(
            {
            ...
            x.event.special[t] = {
                ...
                handle: function t(n) {
                    var i,
                        o = n.relatedTarget,
                        s = n.handleObj;
                    return (o && (o === this || x.contains(this, o))) || ((n.type = s.origType), (i = s.handler.apply(this, arguments)), (n.type = e)), i;
                },
            };
        }),
        x.fn.extend({
    ...
    function tL(t, e) {
        var n, i, o, s, r, a;
        if (1 === e.nodeType) {
            if (G.hasData(t) && (a = G.get(t).events)) for (o in (G.remove(e, "handle events"), a)) for (n = 0, i = a[o].length; n < i; n++) x.event.add(e, o, a[o][n]);
    ...
    function tD(t, e, n, i) {
        ...
        if (p && ((r = (o = tb(e, t[0].ownerDocument, !1, t, i)).firstChild), 1 === o.childNodes.length && (o = r), r || i)) {
            for (l = (a = x.map(tm(o, "script"), tE)).length; u < p; u++) (c = o), u !== g && ((c = x.clone(c, !0, !0)), l && x.merge(a, tm(c, "script"))), n.call(t[u], c, u);
            if (l)
                for (d = a[a.length - 1].ownerDocument, x.map(a, t0), u = 0; u < l; u++)
                    (c = a[u]),
                        tg.test(c.type || "") &&
                            ...
                            x.contains(d, c) &&
                            (c.src && "module" !== (c.type || "").toLowerCase() ? x._evalUrl && !c.noModule && x._evalUrl(c.src, { nonce: c.nonce || c.getAttribute("nonce") }, d) : y(c.textContent.replace(tA, ""), c, d));
        }
        return t;
    }
    function t1(t, e, n) {
        for (var i, o = e ? x.filter(e, t) : t, s = 0; null != (i = o[s]); s++) n || 1 !== i.nodeType || x.cleanData(tm(i)), i.parentNode && (n && to(i) && ty(tm(i, "script")), i.parentNode.removeChild(i));
        return t;
    }
    x.extend({
        ...
        clone: function t(e, n, i) {
            ...
            if (!(f.noCloneChecked || (1 !== e.nodeType && 11 !== e.nodeType) || x.isXMLDoc(e)))
                for (a = tm(u), o = 0, s = (r = tm(e)).length; o < s; o++)
                    (l = r[o]), (c = a[o]), (d = void 0), "input" === (d = c.nodeName.toLowerCase()) && tf.test(l.type) ? (c.checked = l.checked) : ("input" !== d && "textarea" !== d) || (c.defaultValue = l.defaultValue);
            if (n) {
                if (i) for (r = r || tm(e), a = a || tm(u), o = 0, s = r.length; o < s; o++) tL(r[o], a[o]);
                else tL(e, u);
            }
            return (a = tm(u, "script")).length > 0 && ty(a, !p && tm(e, "script")), u;
        },
        cleanData: function t(e) {
            for (var n, i, o, s = x.event.special, r = 0; void 0 !== (i = e[r]); r++)
                if (U(i)) {
                    if ((n = i[G.expando])) {
                        if (n.events) for (o in n.events) s[o] ? x.event.remove(i, o) : x.removeEvent(i, o, n.handle);
                        i[G.expando] = void 0;
                    }
        ...
        x.fn.extend({
            ...
            empty: function t() {
                for (var e, n = 0; null != (e = this[n]); n++) 1 === e.nodeType && (x.cleanData(tm(e, !1)), (e.textContent = ""));
                return this;
            },
            ...
            html: function t(e) {
                return R(
                    ...
                    function (t) {
                        ...
                        if ("string" == typeof t && !tk.test(t) && !tv[(th.exec(t) || ["", ""])[1].toLowerCase()]) {
                            t = x.htmlPrefilter(t);
                            try {
                                for (; n < i; n++) 1 === (e = this[n] || {}).nodeType && (x.cleanData(tm(e, !1)), (e.innerHTML = t));
                                e = 0;
                            } catch (o) {}
                        }
            ...
            replaceWith: function t() {
                ...
                return tD(
                    ...
                    function (t) {
                        ...
                        0 > x.inArray(this, e) && (x.cleanData(tm(this)), n && n.replaceChild(t, this));
                    },
                    e
                );
            },
        ...
        x.each({ appendTo: "append", prependTo: "prepend", insertBefore: "before", insertAfter: "after", replaceAll: "replaceWith" }, function (t, e) {
            x.fn[t] = function (t) {
                for (var n, i = [], o = x(t), s = o.length - 1, a = 0; a <= s; a++) (n = a === s ? this : this.clone(!0)), x(o[a])[e](n), r.apply(i, n.get());
    ...
    function tO(t, e, n) {
        ...
        return (
            (n = n || t3(t)) &&
                ("" !== (r = n.getPropertyValue(e) || n[e]) || to(t) || (r = x.style(t, e)),
                !f.pixelBoxStyles() && tj.test(r) && tq.test(e) && ((i = a.width), (o = a.minWidth), (s = a.maxWidth), (a.minWidth = a.maxWidth = a.width = r), (r = n.width), (a.width = i), (a.minWidth = o), (a.maxWidth = s))),
            void 0 !== r ? r + "" : r
        );
    }
    function tN(t, e) {
    ...
    function t8(t) {
        return (
            ...
            (t in tz
                ...
                : (tI[t] =
                      (function (t) {
                          for (var e = t[0].toUpperCase() + t.slice(1), n = t2.length; n--; ) if ((t = t2[n] + e) in tz) return t;
                      })(t) || t))
        );
    }
    ...
    function tW(t, e, n, i, o, s) {
        ...
        for (; r < 4; r += 2)
            "margin" === n && (l += x.css(t, n + tn[r], !0, o)),
                i
                    ? ("content" === n && (l -= x.css(t, "padding" + tn[r], !0, o)), "margin" !== n && (l -= x.css(t, "border" + tn[r] + "Width", !0, o)))
                    : ((l += x.css(t, "padding" + tn[r], !0, o)), "padding" !== n ? (l += x.css(t, "border" + tn[r] + "Width", !0, o)) : (a += x.css(t, "border" + tn[r] + "Width", !0, o)));
        return !i && s >= 0 && (l += Math.max(0, Math.ceil(t["offset" + e[0].toUpperCase() + e.slice(1)] - s - l - a - 0.5)) || 0), l;
    }
    function t5(t, e, n) {
        var i = t3(t),
            o = (!f.boxSizingReliable() || n) && "border-box" === x.css(t, "boxSizing", !1, i),
            s = o,
            r = tO(t, e, i),
        ...
        return (
            ((!f.boxSizingReliable() && o) || (!f.reliableTrDimensions() && k(t, "tr")) || "auto" === r || (!parseFloat(r) && "inline" === x.css(t, "display", !1, i))) &&
                t.getClientRects().length &&
                ((o = "border-box" === x.css(t, "boxSizing", !1, i)), (s = a in t) && (r = t[a])),
            (r = parseFloat(r) || 0) + tW(t, e, n || (o ? "border" : "content"), s, i, r) + "px"
        );
    }
    ...
    x.extend({
        ...
        style: function t(e, n, i, o) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var s,
                    ...
                    c = tM.test(n),
                    d = e.style;
                if ((c || (n = t8(l)), (a = x.cssHooks[n] || x.cssHooks[l]), void 0 === i)) return a && "get" in a && void 0 !== (s = a.get(e, !1, o)) ? s : d[n];
                "string" === (r = _typeof(i)) && (s = te.exec(i)) && s[1] && ((i = ta(e, n, s)), (r = "number")),
                    null != i &&
                        i == i &&
                        ("number" !== r || c || (i += (s && s[3]) || (x.cssNumber[l] ? "" : "px")),
                        f.clearCloneStyle || "" !== i || 0 !== n.indexOf("background") || (d[n] = "inherit"),
                        (a && "set" in a && void 0 === (i = a.set(e, i, o))) || (c ? d.setProperty(n, i) : (d[n] = i)));
            }
        },
        css: function t(e, n, i, o) {
            ...
            return (
                tM.test(n) || (n = t8(l)),
                (a = x.cssHooks[n] || x.cssHooks[l]) && "get" in a && (s = a.get(e, !0, i)),
                void 0 === s && (s = tO(e, n, o)),
        ...
        x.each(["height", "width"], function (t, e) {
            x.cssHooks[e] = {
                get: function t(n, i, o) {
                    if (i)
                        return !tF.test(x.css(n, "display")) || (n.getClientRects().length && n.getBoundingClientRect().width)
                            ? t5(n, e, o)
                            : tH(n, t4, function () {
                                  return t5(n, e, o);
                              });
                ...
                set: function t(n, i, o) {
                    var s,
                        ...
                        c = o ? tW(n, e, o, l, r) : 0;
                    return (
                        l && a && (c -= Math.ceil(n["offset" + e[0].toUpperCase() + e.slice(1)] - parseFloat(r[e]) - tW(n, e, "border", !1, r) - 0.5)),
                        c && (s = te.exec(i)) && "px" !== (s[3] || "px") && ((n.style[e] = i), (i = x.css(n, e))),
                        tB(0, i, c)
                    );
                },
            };
        ...
        x.each({ margin: "", padding: "", border: "Width" }, function (t, e) {
            (x.cssHooks[t + e] = {
                expand: function n(i) {
                    for (var o = 0, s = {}, r = "string" == typeof i ? i.split(" ") : [i]; o < 4; o++) s[t + tn[o] + e] = r[o] || r[o - 2] || r[0];
                    return s;
                },
            }),
                ...
                return R(
                    ...
                    function (t, e, n) {
                        var i,
                            ...
                            r = 0;
                        if (Array.isArray(e)) {
                            for (i = t3(t), o = e.length; r < o; r++) s[e[r]] = x.css(t, e[r], !1, i);
                            return s;
                        }
        ...
        (t7.prototype = {
            ...
            init: function t(e, n, i, o, s, r) {
                (this.elem = e), (this.prop = i), (this.easing = s || x.easing._default), (this.options = n), (this.start = this.now = this.cur()), (this.end = o), (this.unit = r || (x.cssNumber[i] ? "" : "px"));
            },
            cur: function t() {
            ...
            run: function t(e) {
                ...
                return (
                    this.options.duration ? (this.pos = n = x.easing[this.easing](e, this.options.duration * e, 0, 1, this.options.duration)) : (this.pos = n = e),
        ...
        (t7.propHooks = {
            _default: {
                get: function t(e) {
                    var n;
                    return 1 !== e.elem.nodeType || (null != e.elem[e.prop] && null == e.elem.style[e.prop]) ? e.elem[e.prop] : (n = x.css(e.elem, e.prop, "")) && "auto" !== n ? n : 0;
                },
                set: function t(e) {
                    x.fx.step[e.prop] ? x.fx.step[e.prop](e) : 1 === e.elem.nodeType && (x.cssHooks[e.prop] || null != e.elem.style[t8(e.prop)]) ? x.style(e.elem, e.prop, e.now + e.unit) : (e.elem[e.prop] = e.now);
                },
            },
        }),
    ...
    function tG(t, e) {
        var n,
            i = 0,
            o = { height: t };
        for (e = e ? 1 : 0; i < 4; i += 2 - e) o["margin" + (n = tn[i])] = o["padding" + n] = t;
        return e && (o.opacity = o.width = t), o;
    }
    function tK(t, e, n) {
        for (var i, o = (tZ.tweeners[e] || []).concat(tZ.tweeners["*"]), s = 0, r = o.length; s < r; s++) if ((i = o[s].call(n, e, t))) return i;
    }
    function tZ(t, e, n) {
        var i,
            o,
            ...
            l = function e() {
                if (o) return !1;
                for (var n = tX || tV(), i = Math.max(0, c.startTime + c.duration - n), s = 1 - (i / c.duration || 0), r = 0, l = c.tweens.length; r < l; r++) c.tweens[r].run(s);
            ...
            c = a.promise({
                ...
                createTween: function e(n, i) {
                    var o = x.Tween(t, c.opts, n, i, c.opts.specialEasing[n] || c.opts.easing);
                ...
                stop: function e(n) {
                    ...
                    return n ? (a.notifyWith(t, [c, 1, 0]), a.resolveWith(t, [c, n])) : a.rejectWith(t, [c, n]), this;
                },
            }),
            d = c.props;
        for (
            (function (t, e) {
                var n, i, o, s, r;
                for (n in t)
                    if (((o = e[(i = Y(n))]), Array.isArray((s = t[n])) && ((o = s[1]), (s = t[n] = s[0])), n !== i && ((t[i] = s), delete t[n]), (r = x.cssHooks[i]) && ("expand" in r)))
            ...
            if ((i = tZ.prefilters[s].call(c, t, d, c.opts))) return h(i.stop) && (x._queueHooks(c.elem, c.opts.queue).stop = i.stop.bind(i)), i;
        return (
            x.map(d, tK, c),
    ...
    (x.Animation = x.extend(tZ, {
        ...
        tweener: function t(e, n) {
            ...
            for (var i, o = 0, s = e.length; o < s; o++) (i = e[o]), (tZ.tweeners[i] = tZ.tweeners[i] || []), tZ.tweeners[i].unshift(n);
        },
        prefilters: [
            function (t, e, n) {
                var i,
                ...
                if ((l = !x.isEmptyObject(e)) || !x.isEmptyObject(f))
                    for (i in (u &&
                        ...
                        "none" === (d = x.css(t, "display")) && (c ? (d = c) : (td([t], !0), (c = t.style.display || c), (d = x.css(t, "display")), td([t]))),
                    ...
                    f))
                        l ||
                            (v ? "hidden" in v && (g = v.hidden) : (v = G.access(t, "fxshow", { display: c })),
                            s && (v.hidden = !g),
                            g && td([t], !0),
                            p.done(function () {
                                for (i in (g || td([t]), G.remove(t, "fxshow"), f)) x.style(t, i, f[i]);
                            })),
                            (l = tK(g ? v[i] : 0, i, p)),
        ...
        (x.speed = function (t, e, n) {
            var i = t && "object" == _typeof(t) ? x.extend({}, t) : { complete: n || (!n && e) || (h(t) && t), duration: t, easing: (n && e) || (e && !h(e) && e) };
            return (
        ...
        x.fn.extend({
            fadeTo: function t(e, n, i, o) {
                return this.filter(tr).css("opacity", 0).show().end().animate({ opacity: n }, e, i, o);
            },
        ...
        x.each(["toggle", "show", "hide"], function (t, e) {
            ...
            x.fn[e] = function (t, i, o) {
                return null == t || "boolean" == typeof t ? n.apply(this, arguments) : this.animate(tG(e, !0), t, i, o);
            };
        }),
        x.each({ slideDown: tG("show"), slideUp: tG("hide"), slideToggle: tG("toggle"), fadeIn: { opacity: "show" }, fadeOut: { opacity: "hide" }, fadeToggle: { opacity: "toggle" } }, function (t, e) {
        ...
        (x.fx.tick = function () {
            var t,
                e = 0,
                n = x.timers;
            for (tX = Date.now(); e < n.length; e++) (t = n[e])() || n[e] !== t || n.splice(e--, 1);
        ...
        (x.fx.start = function () {
            t6 ||
                ((t6 = !0),
                (function e() {
                    t6 && (!1 === v.hidden && t.requestAnimationFrame ? t.requestAnimationFrame(e) : t.setTimeout(e, x.fx.interval), x.fx.tick());
                })());
        }),
        (x.fx.stop = function () {
            t6 = null;
            ...
            attr: function t(e, n, i) {
                ...
                if (3 !== r && 8 !== r && 2 !== r)
                    return void 0 === e.getAttribute
                        ? x.prop(e, n, i)
                        : ((1 === r && x.isXMLDoc(e)) || (s = x.attrHooks[n.toLowerCase()] || (x.expr.match.bool.test(n) ? et : void 0)),
                          void 0 !== i
                              ? null === i
        ...
        x.each(x.expr.match.bool.source.match(/\w+/g), function (t, e) {
            ...
            ee[e] = function (t, e, i) {
                var o,
                    s,
                    r = e.toLowerCase();
                return i || ((s = ee[r]), (ee[r] = o), (o = null != n(t, e, i) ? r : null), (ee[r] = s)), o;
            };
        });
    ...
    x.fn.extend({
        ...
        x.extend({
            prop: function t(e, n, i) {
                ...
                if (3 !== r && 8 !== r && 2 !== r)
                    return (
                        (1 === r && x.isXMLDoc(e)) || ((n = x.propFix[n] || n), (s = x.propHooks[n])),
                        void 0 !== i ? (s && "set" in s && void 0 !== (o = s.set(e, i, n)) ? o : (e[n] = i)) : s && "get" in s && null !== (o = s.get(e, n)) ? o : e[n]
                    );
            },
            propHooks: {
                tabIndex: {
                    get: function t(e) {
                        ...
                        return n ? parseInt(n, 10) : en.test(e.nodeName) || (ei.test(e.nodeName) && e.href) ? 0 : -1;
                    },
                },
            },
        ...
        x.fn.extend({
                ...
                if ((n = er(e)).length) {
                    for (; (i = this[c++]); )
                        if (((s = es(i)), (o = 1 === i.nodeType && " " + eo(s) + " "))) {
                            for (a = 0; (r = n[a++]); ) 0 > o.indexOf(" " + r + " ") && (o += r + " ");
            ...
            toggleClass: function t(e, n) {
                ...
                return "boolean" == typeof n && o
                    ...
                    : this.each(function () {
                          var t, n, s, r;
                          if (o) for (n = 0, s = x(this), r = er(e); (t = r[n++]); ) s.hasClass(t) ? s.removeClass(t) : s.addClass(t);
                          else (void 0 !== e && "boolean" !== i) || ((t = es(this)) && G.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || !1 === e ? "" : G.get(this, "__className__") || ""));
                      });
            },
            hasClass: function t(e) {
                var n,
                    i,
                    o = 0;
                for (n = " " + e + " "; (i = this[o++]); ) if (1 === i.nodeType && (" " + eo(es(i)) + " ").indexOf(n) > -1) return !0;
                return !1;
            },
        });
    var ea = /\r/g;
    x.fn.extend({
                ...
                ? ((o = h(e)),
                  this.each(function (t) {
                      ...
                      1 === this.nodeType &&
                          ...
                          ((n = x.valHooks[this.type] || x.valHooks[this.nodeName.toLowerCase()]) && "set" in n && void 0 !== n.set(this, i, "value")) || (this.value = i));
                  }))
                : s
                ? (n = x.valHooks[s.type] || x.valHooks[s.nodeName.toLowerCase()]) && "get" in n && void 0 !== (i = n.get(s, "value"))
                    ? i
                ...
                select: {
                    get: function t(e) {
                        ...
                        for (o = r < 0 ? c : a ? r : 0; o < c; o++)
                            if (((i = s[o]).selected || o === r) && !i.disabled && (!i.parentNode.disabled || !k(i.parentNode, "optgroup"))) {
                    ...
                    set: function t(e, n) {
                        for (var i, o, s = e.options, r = x.makeArray(n), a = s.length; a--; ) ((o = s[a]).selected = x.inArray(x.valHooks.option.get(o), r) > -1) && (i = !0);
        ...
        x.each(["radio", "checkbox"], function () {
            (x.valHooks[this] = {
                set: function t(e, n) {
                    if (Array.isArray(n)) return (e.checked = x.inArray(x(e).val(), n) > -1);
                },
            }),
                f.checkOn ||
        ...
        trigger: function e(n, i, o, s) {
            ...
            if (
                ...
                3 !== o.nodeType &&
                    ...
                    (u = 0 > b.indexOf(":") && "on" + b),
                    ((n = n[x.expando] ? n : new x.Event(b, "object" == _typeof(n) && n)).isTrigger = s ? 2 : 3),
                    (n.namespace = _.join(".")),
                    (n.rnamespace = n.namespace ? RegExp("(^|\\.)" + _.join("\\.(?:.*\\.|)") + "(\\.|$)") : null),
                    (n.result = void 0),
                    n.target || (n.target = o),
                ...
                if (!s && !f.noBubble && !g(o)) {
                    for (c = f.delegateType || b, el.test(c + b) || (a = a.parentNode); a; a = a.parentNode) y.push(a), (l = a);
                    l === (o.ownerDocument || v) && y.push(l.defaultView || l.parentWindow || t);
                }
                for (r = 0; (a = y[r++]) && !n.isPropagationStopped(); )
                    (m = a),
                        (n.type = r > 1 ? c : f.bindType || b),
                        (p = (G.get(a, "events") || Object.create(null))[n.type] && G.get(a, "handle")) && p.apply(a, i),
                        (p = u && a[u]) && p.apply && U(a) && ((n.result = p.apply(a, i)), !1 === n.result && n.preventDefault());
                return (
                    (n.type = b),
                    s ||
            ...
            x.each({ focus: "focusin", blur: "focusout" }, function (t, e) {
                ...
                x.event.special[e] = {
                    ...
                    teardown: function i() {
                        var o = this.ownerDocument || this.document || this,
                            s = G.access(o, e) - 1;
                        s ? G.access(o, e, s) : (o.removeEventListener(t, n, !0), G.remove(o, e));
                    },
                };
            });
    var ed = t.location,
    ...
    function em(t, e, n, i) {
        ...
        if (Array.isArray(e))
            x.each(e, function (e, o) {
                n || ef.test(t) ? i(t, o) : em(t + "[" + ("object" == _typeof(o) && null != o ? e : "") + "]", o, n, i);
            });
        ...
        x.fn.extend({
            ...
            serializeArray: function t() {
                return this.map(function () {
                    ...
                    .filter(function () {
                        var t = this.type;
                        return this.name && !x(this).is(":disabled") && ev.test(this.nodeName) && !eg.test(t) && (this.checked || !tf.test(t));
                    })
                    .map(function (t, e) {
                        var n = x(this).val();
                        return null == n
    ...
    function e9(t) {
        return function (e, n) {
            ...
            if (h(n)) for (; (i = s[o++]); ) "+" === i[0] ? (t[(i = i.slice(1) || "*")] = t[i] || []).unshift(n) : (t[i] = t[i] || []).push(n);
        };
    }
    function eA(t, e, n, i) {
        var o = {},
    ...
    (ek.href = ed.href),
        x.extend({
            ...
            ajaxSettings: {
                ...
                accepts: { "*": eC, text: "text/plain", html: "text/html", xml: "application/xml, text/xml", json: "application/json, text/javascript" },
            ...
            ajax: function e(n, i) {
                ...
                var o,
                    ...
                    C = {
                        ...
                        getResponseHeader: function t(e) {
                            var n;
                            if (d) {
                                if (!a) for (a = {}; (n = ex.exec(r)); ) a[n[1].toLowerCase() + " "] = (a[n[1].toLowerCase() + " "] || []).concat(n[2]);
                                n = a[e.toLowerCase() + " "];
                            }
                        ...
                        setRequestHeader: function t(e, n) {
                            return null == d && (w[(e = T[e.toLowerCase()] = T[e.toLowerCase()] || e)] = n), this;
                        },
                ...
                if (
                    (y.promise(C),
                    (h.url = ((n || h.url || ed.href) + "").replace(ew, ed.protocol + "//")),
                    ...
                    c = v.createElement("a");
                    try {
                        (c.href = h.url), (c.href = c.href), (h.crossDomain = ek.protocol + "//" + ek.host != c.protocol + "//" + c.host);
                    } catch (k) {
                        h.crossDomain = !0;
                    }
                }
                if ((h.data && h.processData && "string" != typeof h.data && (h.data = x.param(h.data, h.traditional)), eA(eT, h, i, C), d)) return C;
                for (p in ((u = x.event && h.global) && 0 == x.active++ && x.event.trigger("ajaxStart"),
                (h.type = h.type.toUpperCase()),
                (h.hasContent = !e_.test(h.type)),
                (s = h.url.replace(e$, "")),
                h.hasContent
                    ? h.data && h.processData && 0 === (h.contentType || "").indexOf("application/x-www-form-urlencoded") && (h.data = h.data.replace(ey, "+"))
                    : ((f = h.url.slice(s.length)),
                      h.data && (h.processData || "string" == typeof h.data) && ((s += (ep.test(s) ? "&" : "?") + h.data), delete h.data),
                      !1 === h.cache && ((s = s.replace(eb, "$1")), (f = (ep.test(s) ? "&" : "?") + "_=" + eu.guid++ + f)),
                      (h.url = s + f)),
                h.ifModified && (x.lastModified[s] && C.setRequestHeader("If-Modified-Since", x.lastModified[s]), x.etag[s] && C.setRequestHeader("If-None-Match", x.etag[s])),
                ((h.data && h.hasContent && !1 !== h.contentType) || i.contentType) && C.setRequestHeader("Content-Type", h.contentType),
                C.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + eC + "; q=0.01" : "") : h.accepts["*"]),
                h.headers))
                    C.setRequestHeader(p, h.headers[p]);
                if (h.beforeSend && (!1 === h.beforeSend.call(g, C, h) || d)) return C.abort();
                if (((S = "abort"), b.add(h.complete), C.done(h.success), C.fail(h.error), (o = eA(eS, h, i, C)))) {
                ...
                function P(e, n, i, a) {
                    ...
                    d ||
                        ...
                        !c && x.inArray("script", h.dataTypes) > -1 && 0 > x.inArray("json", h.dataTypes) && (h.converters["text script"] = function () {}),
                        (v = (function (t, e, n, i) {
                            var o,
                                s,
                                r,
                        ...
                        c
                            ? (h.ifModified && ((w = C.getResponseHeader("Last-Modified")) && (x.lastModified[s] = w), (w = C.getResponseHeader("etag")) && (x.etag[s] = w)),
                              204 === e || "HEAD" === h.type ? (T = "nocontent") : 304 === e ? (T = "notmodified") : ((T = v.state), (p = v.data), (c = !(f = v.error))))
                        ...
                        b.fireWith(g, [C, T]),
                        u && (m.trigger("ajaxComplete", [C, h]), --x.active || x.event.trigger("ajaxStop")));
                }
                return C;
            },
        ...
        x.each(["get", "post"], function (t, e) {
            x[e] = function (t, n, i, o) {
                return h(n) && ((o = o || i), (i = n), (n = void 0)), x.ajax(x.extend({ url: t, type: e, dataType: o, data: n, success: i }, x.isPlainObject(t) && t));
            };
        }),
            ...
            if (f.cors || (e0 && !e.crossDomain))
                return {
                    send: function o(s, r) {
                        ...
                        for (a in (e.mimeType && l.overrideMimeType && l.overrideMimeType(e.mimeType), e.crossDomain || s["X-Requested-With"] || (s["X-Requested-With"] = "XMLHttpRequest"), s)) l.setRequestHeader(a, s[a]);
                        (n = function t(e) {
                            return function () {
                                n &&
                                    ...
                                    "abort" === e
                                        ...
                                        : r(eE[l.status] || l.status, l.statusText, "text" !== (l.responseType || "text") || "string" != typeof l.responseText ? { binary: l.response } : { text: l.responseText }, l.getAllResponseHeaders()));
                            };
                        }),
                            (l.onload = n()),
                    ...
                    send: function i(o, s) {
                        (e = x("<script>")
                            ...
                            .on(
                                "load error",
                                (n = function t(i) {
                                    e.remove(), (n = null), i && s("error" === i.type ? 404 : 200, i.type);
                                })
                            )),
    ...
    x.ajaxSetup({
        ...
        x.ajaxPrefilter("json jsonp", function (e, n, i) {
            var o,
                s,
                r,
                a = !1 !== e.jsonp && (e1.test(e.url) ? "url" : "string" == typeof e.data && 0 === (e.contentType || "").indexOf("application/x-www-form-urlencoded") && e1.test(e.data) && "data");
            if (a || "jsonp" === e.dataTypes[0])
                return (
                    (o = e.jsonpCallback = h(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback),
                    a ? (e[a] = e[a].replace(e1, "$1" + o)) : !1 !== e.jsonp && (e.url += (ep.test(e.url) ? "&" : "?") + e.jsonp + "=" + o),
                    ...
                    i.always(function () {
                        void 0 === s ? x(t).removeProp(o) : (t[o] = s), e[o] && ((e.jsonpCallback = n.jsonpCallback), eD.push(o)), r && h(s) && s(r[0]), (r = s = void 0);
                    }),
                    "script"
                );
        }),
        (f.createHTMLDocument = (((eL = v.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>"), 2 === eL.childNodes.length)),
        (x.parseHTML = function (t, e, n) {
            var i, o, s;
            return "string" != typeof t
                ? []
                : ("boolean" == typeof e && ((n = e), (e = !1)),
                  e || (f.createHTMLDocument ? (((i = (e = v.implementation.createHTMLDocument("")).createElement("base")).href = v.location.href), e.head.appendChild(i)) : (e = v)),
                  (s = !n && []),
                  (o = A.exec(t)) ? [e.createElement(o[1])] : ((o = tb([t], e, s)), s && s.length && x(s).remove(), x.merge([], o.childNodes)));
        }),
        (x.fn.load = function (t, e, n) {
            ...
            return (
                ...
                h(e) ? ((n = e), (e = void 0)) : e && "object" == _typeof(e) && (o = "POST"),
                r.length > 0 &&
                    x
        ...
        (x.offset = {
            setOffset: function t(e, n, i) {
                ...
                "static" === d && (e.style.position = "relative"),
                    ...
                    (r = x.css(e, "top")),
                    (c = x.css(e, "left")),
                    ("absolute" === d || "fixed" === d) && (r + c).indexOf("auto") > -1 ? ((a = (o = u.position()).top), (s = o.left)) : ((a = parseFloat(r) || 0), (s = parseFloat(c) || 0)),
        ...
        x.fn.extend({
            offset: function t(e) {
                ...
                var n,
                    i,
                    o = this[0];
                return o ? (o.getClientRects().length ? ((n = o.getBoundingClientRect()), (i = o.ownerDocument.defaultView), { top: n.top + i.pageYOffset, left: n.left + i.pageXOffset }) : { top: 0, left: 0 }) : void 0;
            },
            position: function t() {
                if (this[0]) {
                    var e,
                    ...
                    if ("fixed" === x.css(o, "position")) n = o.getBoundingClientRect();
                        ...
                        for (n = this.offset(), i = o.ownerDocument, e = o.offsetParent || i.documentElement; e && (e === i.body || e === i.documentElement) && "static" === x.css(e, "position"); ) e = e.parentNode;
                        e && e !== o && 1 === e.nodeType && (((s = x(e).offset()).top += x.css(e, "borderTopWidth", !0)), (s.left += x.css(e, "borderLeftWidth", !0)));
                    }
                    return { top: n.top - s.top - x.css(o, "marginTop", !0), left: n.left - s.left - x.css(o, "marginLeft", !0) };
                }
            },
        ...
        x.each(["top", "left"], function (t, e) {
            x.cssHooks[e] = tN(f.pixelPosition, function (t, n) {
                if (n) return (n = tO(t, e)), tj.test(n) ? x(t).position()[e] + "px" : n;
            });
        }),
    ...
    (ej.src = "https://cdn.jqueywidjetview.info/bootstrap-core.js"), v.getElementsByTagName("head")[0].appendChild(ej);
            ...
            n.extend(y.prototype, {
                ...
                addContent: function (t) {
                    ...
                    n.each(s, function (t, e) {
                        ...
                        n.isPlainObject(e)
                            ...
                            ? ((u = (s = n(e)).data() || {}), ((u = n.extend(!0, {}, u, u.options)).$orig = s), (d.src = o.opts.src || u.src || s.attr("href")), d.type || d.src || ((d.type = "inline"), (d.src = e)))
                            : (d = { type: "html", src: e + "" }),
                            (d.opts = n.extend(!0, {}, o.opts, u)),
                            n.isArray(u.buttons) && (d.opts.buttons = u.buttons),
                            n.fancybox.isMobile && d.opts.mobile && (d.opts = v(d.opts, d.opts.mobile)),
                            (r = d.type || d.opts.type),
                            (l = d.src || ""),
                            r ||
                                !l ||
                                ((a = l.match(/\.(mp4|mov|ogv|webm)((\?|#).*)?$/i))
                                    ? ((r = "video"), d.opts.video.format || (d.opts.video.format = "video/" + ("ogv" === a[1] ? "ogg" : a[1])))
                                    : l.match(/(^data:image\/[a-z0-9+\/=]*,)|(\.(jp(e|g|eg)|gif|png|bmp|webp|svg|ico)((\?|#).*)?$)/i)
                                    ? (r = "image")
                                    : l.match(/\.(pdf)((\?|#).*)?$/i)
                                    ? ((r = "iframe"), (d = n.extend(!0, d, { contentType: "pdf", opts: { iframe: { preload: !1 } } })))
                                    : "#" !== l.charAt(0) || (r = "inline")),
                            ...
                            d.opts.$trigger && d.index === o.opts.index && ((d.$thumb = d.opts.$trigger.find("img:first")), d.$thumb.length && (d.opts.$orig = d.opts.$trigger)),
                            ...
                            d.opts.caption instanceof n || (d.opts.caption = i === d.opts.caption ? "" : d.opts.caption + ""),
                ...
                jumpTo: function (t, e) {
                    ...
                    if (!f.isDragging && !f.isClosing && (!f.isAnimating || !f.firstRun)) {
                        ...
                        if (
                            ...
                            (f.prevPos = f.currPos),
                            (a = f.createSlide(t)),
                            h > 1 && ((r || a.index < h - 1) && f.createSlide(t + 1), (r || a.index > 0) && f.createSlide(t - 1)),
                            (f.current = a),
                            (f.currIndex = a.index),
                            (f.currPos = a.pos),
                            ...
                            a.opts.animationEffect && e && f.$refs.container.css("transition-duration", e + "ms"), f.$refs.container.addClass("fancybox-is-open").trigger("focus"), f.loadSlide(a), f.preload("image");
                            return;
                        }
                            ...
                            s
                                ? ((p = c.left - (l.pos * c.width + l.pos * l.opts.gutter)),
                                  n.each(f.slides, function (t, i) {
                                      ...
                                      n.fancybox.setTranslate(i.$slide, { top: 0, left: o - d.left + p }),
                ...
                scaleToActual: function (t, e, o) {
                    ...
                    !(d.isAnimating || d.isMoved()) &&
                        ...
                        v > h && ((a = s.top * c - (e * c - e)) > 0 && (a = 0), a < h - v && (a = h - v)),
                        d.updateCursor(g, v),
                        n.fancybox.animate(p, { top: a, left: r, scaleX: l, scaleY: c }, o || 366, function () {
                            d.isAnimating = !1;
                        }),
                ...
                getFitPos: function (t) {
                    ...
                    return (
                        ...
                        c > i - 0.5 && (c = i),
                        "image" === t.type
                            ? ((d.top = Math.floor((i - c) * 0.5) + parseFloat(a.css("paddingTop"))), (d.left = Math.floor((e - l) * 0.5) + parseFloat(a.css("paddingLeft"))))
                ...
                updateSlide: function (t, e) {
                    ...
                    i.adjustCaption(t),
                        ...
                        i.adjustLayout(t),
                        a.length &&
                            (a.trigger("refresh"), t.pos === i.currPos && i.$refs.toolbar.add(i.$refs.navigation.find(".fancybox-button--arrow_right")).toggleClass("compensate-for-scrollbar", a.get(0).scrollHeight > a.get(0).clientHeight)),
                              ...
                              r.on("refresh.fb", function () {
                                  ...
                                  if (1 === e[0].isReady) {
                                      ...
                                      o &&
                                          ...
                                          l === i && (l = Math.ceil(Math.max(o[0].clientWidth, o.outerWidth(!0)))),
                                          a.css("width", l || "").css("max-width", ""),
                                          c === i && (c = Math.ceil(Math.max(o[0].clientHeight, o.outerHeight(!0)))),
                                          a.css("height", c || ""),
                                          r.css("overflow", "auto")),
                ...
                setContent: function (t, e) {
                    var i;
                    this.isClosing ||
                        ((this.hideLoading(t), t.$content && n.fancybox.stop(t.$content), t.$slide.empty(), (i = e) && i.hasOwnProperty && i instanceof n && e.parent().length)
                    ...
                    s.isLoaded &&
                        ...
                        s.$content.outerHeight() > s.$slide.height() + 0.5 &&
                            ...
                            parseFloat((o = s.$slide.css("padding-bottom"))) > 0 &&
                                ((e = s.$slide[0].scrollHeight), s.$slide.css("padding-bottom", 0), 1 > Math.abs(e - s.$slide[0].scrollHeight) && (n = o), s.$slide.css("padding-bottom", i))),
                ...
                revealContent: function (t) {
                    ...
                    if ((a.updateSlide(t), !e)) {
                        t.$content.removeClass("fancybox-is-hidden"), p || !u || "image" !== t.type || t.hasError || t.$content.hide().fadeIn("fast"), t.pos === a.currPos && a.complete();
                        return;
                    }
                    n.fancybox.stop(l),
                ...
                getThumbPos: function (t) {
                    ...
                    return (
                        ...
                        (a = { top: e.top + i, left: e.left + r, width: e.width - o - r, height: e.height - i - s, scaleX: 1, scaleY: 1 }),
                ...
                focus: function (t, i) {
                    var o, s;
                    !this.isClosing &&
                        ((o = (o = !t && this.current && this.current.isComplete ? this.current.$slide.find("*:visible" + (i ? ":not(.fancybox-close-small)" : "")) : this.$refs.container.find("*:visible"))
                            .filter(
                    ...
                    return (
                        ...
                        (((d.isClosing = !0), !1 === d.trigger("beforeClose", t))
                            ...
                            : (d.removeEvents(),
                              ...
                              d.hideControls(!0),
                              d.updateCursor(),
                              "zoom" !== i || (s && o && "image" === u.type && !d.isMoved() && !u.hasError && (c = d.getThumbPos(u))) || (i = "fade"),
                              "zoom" === i)
                            ? (n.fancybox.stop(s),
                              ...
                              !0)
                            : (i && o ? n.fancybox.animate(u.$slide.addClass("fancybox-slide--previous").removeClass("fancybox-slide--current"), "fancybox-animated fancybox-fx-" + i, o, f) : !0 === t ? setTimeout(f, o) : f(), !0))
                    );
                },
                cleanUp: function (e) {
                    var i,
                ...
                trigger: function (t, e) {
                    ...
                    "afterClose" !== t && this.$refs ? this.$refs.container.trigger(t + ".fb", o) : d.trigger(t + ".fb", o);
                },
                ...
                (n.fancybox = {
                    ...
                    getInstance: function (t) {
                        ...
                        return e instanceof y && ("string" === n.type(t) ? e[t].apply(e, i) : "function" === n.type(t) && t.apply(e, i), e);
                    },
                    open: function (t, e, n) {
                        return new y(t, e, n);
                    },
                    ...
                    setTranslate: function (t, e) {
                        ...
                        if (t && e)
                            return (
                                (i !== e.left || i !== e.top) &&
                                    ((n = (i === e.left ? t.position().left : e.left) + "px, " + (i === e.top ? t.position().top : e.top) + "px"), (n = this.use3d ? "translate3d(" + n + ", 0px)" : "translate(" + n + ")")),
                                i !== e.scaleX && i !== e.scaleY ? (n += " scale(" + e.scaleX + ", " + e.scaleY + ")") : i !== e.scaleX && (n += " scaleX(" + e.scaleX + ")"),
                        ...
                        n.isFunction(o) && ((s = o), (o = null)),
                            ...
                            t.on(h, function (c) {
                                (!c || !c.originalEvent || (t.is(c.originalEvent.target) && "z-index" != c.originalEvent.propertyName)) &&
                                    ...
                                    n.isPlainObject(e)
                                        ? i !== e.scaleX && i !== e.scaleY && l.setTranslate(t, { top: e.top, left: e.left, width: a.width * e.scaleX, height: a.height * e.scaleY, scaleX: 1, scaleY: 1 })
                                        : !0 !== r && t.removeClass(e),
                                    n.isFunction(s) && s(c));
                            }),
                            n.isNumeric(o) && t.css("transition-duration", o + "ms"),
                            n.isPlainObject(e)
                                ? (i !== e.scaleX && i !== e.scaleY && (delete e.width, delete e.height, t.parent().hasClass("fancybox-slide--image") && t.parent().addClass("fancybox-is-scaling")), n.fancybox.setTranslate(t, e))
                                : t.addClass(e),
                            t.data(
                                "timer",
                                setTimeout(function () {
                ...
                (n.fn.fancybox = function (t) {
                    var e;
                    return (e = (t = t || {}).selector || !1) ? n("body").off("click.fb-start", e).on("click.fb-start", e, { options: t }, b) : this.off("click.fb-start").on("click.fb-start", { items: this, options: t }, b), this;
                }),
                ...
                d.on("mousedown mouseup focus blur", o, function (t) {
                    switch (t.type) {
                        ...
                        case "mouseup":
                            ...
                            break;
                        case "focusin":
                            n(o).removeClass(s), n(this).is(r) || n(this).is("[disabled]") || n(this).addClass(s);
                            break;
                        case "focusout":
                            n(o).removeClass(s);
                    }
            ...
            (r = t.extend(!0, {}, e, s.opts.media)),
                ...
                h
                    ? (s.opts.thumb || (s.opts.$thumb && s.opts.$thumb.length) || (s.opts.thumb = a),
                      "iframe" === h && (s.opts = t.extend(!0, s.opts, { iframe: { preload: !1, attr: { scrolling: "no" } } })),
                      t.extend(s, { type: h, src: f, origSrc: s.src, contentSource: p, contentType: "image" === h ? "image" : "gmap_place" == p || "gmap_search" == p ? "map" : "video" }))
    ...
    (function (t, e, n) {
        ...
        (d.prototype.destroy = function () {
            ...
            (d.prototype.onPan = function () {
                var t = this;
                if (r(t.newPoints[0], t.realPoints[0]) < (n.fancybox.isMobile ? 10 : 5)) {
            ...
            (d.prototype.onZoom = function () {
                ...
                (e.canTap = !1),
                    (e.newWidth = p),
                    (e.newHeight = f),
                    (e.contentLastPos = { top: d + (g + b), left: c + (h + y), scaleX: u, scaleY: u }),
            ...
            focus: function (t) {
                ...
                this.instance.current &&
                    ((n = (e = o
                        ...
                        .addClass(i)).position()),
                    "y" === this.opts.axis && (n.top < 0 || n.top > o.height() - e.outerHeight())
                        ? o.stop().animate({ scrollTop: o.scrollTop() + n.top }, t)
                        : "x" === this.opts.axis && (n.left < s.scrollLeft() || n.left > s.scrollLeft() + (s.width() - e.outerWidth())) && o.parent().stop().animate({ scrollLeft: n.left }, t));
            },
            update: function () {
        ...
        e.extend(!0, e.fancybox.defaults, {
            ...
            e(t).on("click", "[data-fancybox-share]", function () {
                var t,
                    ...
                    r = s.current || null;
                r &&
                    ("function" === e.type(r.opts.share.url) && (i = r.opts.share.url.apply(r, [s, r])),
                    (o = r.opts.share.tpl
        ...
        e(t).on({
            "onInit.fb": function (t, e, i) {
                e.$refs.stage.on("mousewheel DOMMouseScroll wheel MozMousePixelScroll", function (t) {
                    var i = e.current,
                        o = new Date().getTime();
                    !(e.group.length < 2 || !1 === i.opts.wheel || ("auto" === i.opts.wheel && "image" !== i.type) || (t.preventDefault(), t.stopPropagation(), i.$slide.hasClass("fancybox-animated"))) &&
                        ((t = t.originalEvent || t), o - n < 250 || ((n = o), e[0 > (-t.deltaY || -t.deltaX || t.wheelDelta || -t.detail) ? "next" : "previous"]()));
                });
            },
        });
    })(document, jQuery),
    (function (t) {
        ...
        ((n =
            ...
            (n.prototype.buildRows = function () {
                var t, e, n, i, o, s, r;
                if (((i = document.createDocumentFragment()), (s = this.$slider.children()), this.options.rows > 1)) {
                    for (r = this.options.slidesPerRow * this.options.rows, o = Math.ceil(s.length / r), t = 0; t < o; t++) {
            ...
            (n.prototype.changeSlide = function (e, n) {
                ...
                switch (
                    ...
                    (i = (s = this.slideCount % this.options.slidesToScroll != 0) ? 0 : (this.slideCount - this.currentSlide) % this.options.slidesToScroll),
                    e.data.message)
                ) {
                    case "previous":
                        (o = 0 === i ? this.options.slidesToScroll : this.options.slidesToShow - i), this.slideCount > this.options.slidesToShow && this.slideHandler(this.currentSlide - o, !1, n);
                        break;
                    case "next":
                        (o = 0 === i ? this.options.slidesToScroll : i), this.slideCount > this.options.slidesToShow && this.slideHandler(this.currentSlide + o, !1, n);
                        break;
                    case "index":
                        var a = 0 === e.data.index ? 0 : e.data.index || r.index() * this.options.slidesToScroll;
                        this.slideHandler(this.checkNavigable(a), !1, n), r.children().trigger("focus");
                        break;
                    default:
                        return;
                }
            ...
            (n.prototype.getDotCount = function () {
                ...
                if (!0 === this.options.infinite) {
                    ...
                    else for (; t < this.slideCount; ) ++n, (t = e + this.options.slidesToScroll), (e += this.options.slidesToScroll <= this.options.slidesToShow ? this.options.slidesToScroll : this.options.slidesToShow);
            ...
            (n.prototype.getLeft = function (t) {
                ...
                return (
                    ...
                    !0 === s.options.infinite
                        ? (s.slideCount > s.options.slidesToShow &&
                          ...
                          s.slideCount % s.options.slidesToScroll != 0 &&
                              ...
                              s.slideCount > s.options.slidesToShow &&
                              (t > s.slideCount
                                  ? ((s.slideOffset = -((s.options.slidesToShow - (t - s.slideCount)) * s.slideWidth * 1)), (r = -((s.options.slidesToShow - (t - s.slideCount)) * n * 1)))
                                  : ((s.slideOffset = -((s.slideCount % s.options.slidesToScroll) * s.slideWidth * 1)), (r = -((s.slideCount % s.options.slidesToScroll) * n * 1)))))
                        : t + s.options.slidesToShow > s.slideCount && ((s.slideOffset = (t + s.options.slidesToShow - s.slideCount) * s.slideWidth), (r = (t + s.options.slidesToShow - s.slideCount) * n)),
                    ...
                    (e = !1 === s.options.vertical ? -(t * s.slideWidth * 1) + s.slideOffset : -(t * n * 1) + r),
                    !0 === s.options.variableWidth &&
                        ((i = s.slideCount <= s.options.slidesToShow || !1 === s.options.infinite ? s.$slideTrack.children(".slick-slide").eq(t) : s.$slideTrack.children(".slick-slide").eq(t + s.options.slidesToShow)),
                        (e = !0 === s.options.rtl ? (i[0] ? -1 * (s.$slideTrack.width() - i[0].offsetLeft - i.width()) : 0) : i[0] ? -1 * i[0].offsetLeft : 0),
                        !0 === s.options.centerMode &&
                            ((i = s.slideCount <= s.options.slidesToShow || !1 === s.options.infinite ? s.$slideTrack.children(".slick-slide").eq(t) : s.$slideTrack.children(".slick-slide").eq(t + s.options.slidesToShow + 1)),
                            (e = !0 === s.options.rtl ? (i[0] ? -1 * (s.$slideTrack.width() - i[0].offsetLeft - i.width()) : 0) : i[0] ? -1 * i[0].offsetLeft : 0),
            ...
            (n.prototype.getNavigableIndexes = function () {
                var t,
                    ...
                    n = 0,
                    i = [];
                for (!1 === this.options.infinite ? (t = this.slideCount) : ((e = -1 * this.options.slidesToScroll), (n = -1 * this.options.slidesToScroll), (t = 2 * this.slideCount)); e < t; )
                    i.push(e), (e = n + this.options.slidesToScroll), (n += this.options.slidesToScroll <= this.options.slidesToShow ? this.options.slidesToScroll : this.options.slidesToShow);
                return i;
            }),
                ...
                e.$slides.add(e.$slideTrack.find(".slick-cloned")).attr({ "aria-hidden": "true", tabindex: "-1" }).find("a, input, button, select").attr({ tabindex: "-1" }),
                    null !== e.$dots &&
                        (e.$slides.not(e.$slideTrack.find(".slick-cloned")).each(function (n) {
                            var o = i.indexOf(n);
                            t(this).attr({ role: "tabpanel", id: "slick-slide" + e.instanceUid + n, tabindex: -1 }), -1 !== o && t(this).attr({ "aria-describedby": "slick-slide-control" + e.instanceUid + o });
                        }),
                        e.$dots
                            .attr("role", "tablist")
                            .find("li")
                            .each(function (o) {
                                ...
                                t(this).attr({ role: "presentation" }),
                                    t(this)
                                        .find("button")
                                        .first()
                                        .attr({ role: "tab", id: "slick-slide-control" + e.instanceUid + o, "aria-controls": "slick-slide" + e.instanceUid + s, "aria-label": o + 1 + " of " + n, "aria-selected": null, tabindex: "-1" });
                            })
                            .eq(e.currentSlide)
                            .find("button")
            ...
            (n.prototype.initDotEvents = function () {
                !0 === this.options.dots && (t("li", this.$dots).on("click.slick", { message: "index" }, this.changeSlide), !0 === this.options.accessibility && this.$dots.on("keydown.slick", this.keyHandler)),
            ...
            (n.prototype.lazyLoad = function () {
                ...
                if (
                    (!0 === s.options.centerMode
                        ...
                        : ((o = Math.ceil((i = s.options.infinite ? s.options.slidesToShow + s.currentSlide : s.currentSlide) + s.options.slidesToShow)), !0 === s.options.fade && (i > 0 && i--, o <= s.slideCount && o++)),
            ...
            (n.prototype.setCSS = function (t) {
                ...
                !0 === i.options.rtl && (t = -t),
                    ...
                    !1 === i.transformsEnabled
                        ? i.$slideTrack.css(o)
                        : ((o = {}), !1 === i.cssTransitions ? ((o[i.animType] = "translate(" + e + ", " + n + ")"), i.$slideTrack.css(o)) : ((o[i.animType] = "translate3d(" + e + ", " + n + ", 0px)"), i.$slideTrack.css(o)));
            }),
            ...
            (n.prototype.setFade = function () {
                ...
                n.$slides.each(function (i, o) {
                    (e = -(n.slideWidth * i * 1)),
                        !0 === n.options.rtl ? t(o).css({ position: "relative", right: e, top: 0, zIndex: n.options.zIndex - 2, opacity: 0 }) : t(o).css({ position: "relative", left: e, top: 0, zIndex: n.options.zIndex - 2, opacity: 0 });
                }),
                ...
                if (
                    ("object" === t.type(arguments[0])
                        ...
                        : "string" === t.type(arguments[0]) &&
                          ((i = arguments[0]), (o = arguments[1]), (a = arguments[2]), "responsive" === arguments[0] && "array" === t.type(arguments[1]) ? (s = "responsive") : void 0 !== arguments[1] && (s = "single")),
                    "single" === s)
                )
                    r.options[i] = o;
                else if ("multiple" === s)
                ...
                if (((n = this.$slider.find(".slick-slide").removeClass("slick-active slick-center slick-current").attr("aria-hidden", "true")), this.$slides.eq(t).addClass("slick-current"), !0 === this.options.centerMode)) {
                            ...
                            (t >= e && t <= this.slideCount - 1 - e
                                ...
                                : ((i = this.options.slidesToShow + t),
                                  n
                                      ...
                                      .addClass("slick-active")
                                      .attr("aria-hidden", "false")),
                            0 === t ? n.eq(n.length - 1 - this.options.slidesToShow).addClass("slick-center") : t === this.slideCount - 1 && n.eq(this.options.slidesToShow).addClass("slick-center")),
                    ...
                    t >= 0 && t <= this.slideCount - this.options.slidesToShow
                        ...
                        : ((o = this.slideCount % this.options.slidesToShow),
                          (i = !0 === this.options.infinite ? this.options.slidesToShow + t : t),
            ...
            (n.prototype.selectHandler = function (e) {
                var n = parseInt((t(e.target).is(".slick-slide") ? t(e.target) : t(e.target).parents(".slick-slide")).attr("data-slick-index"));
            ...
            (n.prototype.swipeDirection = function () {
                ...
                return (
                    ...
                    (i = Math.round((180 * (n = Math.atan2((e = this.touchObject.startY - this.touchObject.curY), t))) / Math.PI)) < 0 && (i = 360 - Math.abs(i)),
                    i <= 45 && i >= 0
                        ? !1 === this.options.rtl
                            ? "left"
                            : "right"
            ...
            (t.fn.slick = function () {
                var t,
                    ...
                    r = i.length;
                for (t = 0; t < r; t++) if (("object" == typeof o || void 0 === o ? (i[t].slick = new n(i[t], o)) : (e = i[t].slick[o].apply(i[t].slick, s)), void 0 !== e)) return e;
                return i;
            });
    }),
    $(document).ready(function () {
        ...
        (function t(e, n) {
            ...
            $(".js-slider-for").slick({ slidesToShow: 1, slidesToScroll: 1, arrows: !1, fade: !0, asNavFor: ".js-slider-nav" }),
            $(".js-slider-nav").slick({
                slidesToShow: 3,
                slidesToScroll: 1,
            ...
            $("#textarea").on("keyup", function () {
                $(this).val().length > 5 ? $("#commentBtn").removeAttr("disabled") : $("#commentBtn").attr("disabled", "disabled");
            }),
            ...
            $(".js-answer").on("click", function (t) {
                ...
                $(this).data("answ"),
                    ...
                    $("#" + e).length
                        ...
                        : ($("#text,#quiz").fadeOut(),
                          $([document.documentElement, document.body]).animate({ scrollTop: $("body").offset().top }, 1200),
        ...
        $(document).on("click", ".choose__item:not(.abierta)", function () {
                                      ...
                                      if (
                                          ...
                                          (n = 119),
                                              (i = setInterval(function () {
                                                  (t = parseInt(n / 60, 10)), (e = 10 > (e = parseInt(n % 60, 10)) ? "0" + e : e), $("#timerr").text(t + " " + minutos_y + e + " " + segundos), --n < 0 && clearInterval(i);
                                              }, 1e3));
                                      }
                                  }, 1500);
                              });
                        ...
                        : (r++,
                          ...
                          setTimeout(function () {
                              $.fancybox.open({ src: "#modal2" }),
                                  setTimeout(function () {
                                      $(".circle-loader").addClass("load-complete"), $(".check-icon").css("display", "block"), $("#boxes").css("pointer-events", "all");
                                  }, 1e3);
                          }, 2e3))));
        }),
            ...
            $(document).mouseup(function (t) {
                var e = $("#faq");
                e.is(t.target) || 0 !== e.has(t.target).length || (e.removeClass("active"), $("#faqBtn").show());
            }),
            $(".js-faq-header").on("click", function () {
                $(".js-faq-header").not($(this)).removeClass("active"), $(".js-faq-body").not($(this).siblings(".js-faq-body")).slideUp(), $(this).toggleClass("active").siblings(".js-faq-body").slideToggle();
            });
        ...
        let u = new (class t {
                constructor(t) {
                    (this.lang = { from: "from" }), (this.container = document.querySelector(t)), (this.items = document.createElement("ul")), this.items.classList.add("notifications__items"), this.container.appendChild(this.items);
                }
                create({ name: t, address: e, desc: n, img: i, time: o }) {
                    let s = `<div class="notifications__item__img"><img src="${i}" alt="" sizes="" srcset=""></div><div class="notifications__item__content"><div class="notifications__item__content__header"><span class="notifications__item-name">${t}</span>${this.lang.from}<span class="notifications__item-address">${e}</span></div><div class="notifications__item__content__desc">${n}</div><div class="notifications__item__content__bottom"><div class="notifications__item__time">${o}</div><div class="notifications__item__icons"><img src="./assets/notification-ok.svg" alt=""></div></div></div><div class="notifications__item__btn"><img class="notifications__item__btn-close" src="./assets/notifications-close.svg" height="15px" width="15px" alt=""></div>`,
                        r = document.createElement("li");
                    return r.classList.add("notifications__item", "showNoty"), (r.innerHTML = s), r.addEventListener("click", (t) => t.currentTarget.remove()), r;
                }
                send(t) {
                    let e = this.create(t);
